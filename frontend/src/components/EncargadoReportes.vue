        ...
        <div class="p-6 space-y-4">
          ...
          <div class="pt-4 border-t border-slate-200 flex justify-end gap-3">
            <button type="button" @click="cerrarModalEvaluacion" class="px-4 py-2 text-sm border rounded-lg">Cancelar</button>
	            <button type="button" @click="enviarEvaluacion" :disabled="isSubmittingEval || !evaluacion.comentarios.trim()" class="px-5 py-2 text-sm bg-blue-900 text-white rounded-lg disabled:opacity-50">
...
const filterEstado = ref<'all' | 'PENDIENTE' | 'VERIFICADO' | 'APROBADO' | 'RECHAZADO'>('all')

  ...
  <div class="min-h-screen umsa-page flex flex-col">
    ...
    <header class="flex items-center justify-between px-8 py-4 relative z-10">
      <span class="text-white/90 font-semibold text-sm tracking-wide">
        Facultad de Ciencias Sociales Â· UMSA
      </span>
      <button
        @click="$router.push('/login')"
        class="flex items-center gap-2 text-sm text-slate-900 border border-white/30 bg-white/90
               px-4 py-2 rounded-lg hover:bg-white transition shadow-sm"
      >
        Iniciar sesiÃ³n
    ...
    <main class="flex-1 flex items-center justify-center px-4 relative z-10">
      ...
      <transition name="slide-fade" mode="out-in">
          ...
          <div class="bg-white rounded-3xl shadow-xl overflow-hidden">
            ...
            <div class="bg-gradient-to-r from-slate-700 to-slate-800 px-7 py-6">
              <div class="flex items-center gap-4">
                ...
                <div>
                  <p class="text-white font-bold text-base leading-tight">Â¡Salida registrada!</p>
        ...
        <!-- â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
             PANTALLA 3: CONFIRMACIÃ“N FINAL
        â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â• -->
        <div v-else-if="pantalla === 'confirmacion'" key="confirmacion"
          ...
          <h2 class="text-2xl font-black text-gray-800">Â¡Todo listo!</h2>
          <p class="text-gray-500 mt-2 text-sm">
            Registro completado.<br />Â¡Hasta maÃ±ana, <strong>{{ datosJornada.nombre }}</strong>!
          </p>

          <div class="mt-6 text-xs text-gray-400">
            Esta ventana se cerrarÃ¡ automÃ¡ticamente en <strong>{{ cuentaRegresiva }}</strong>s
          </div>
...
// â”€â”€ Pantallas: 'fichaje' | 'reporte' â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// â”€â”€ ConfirmaciÃ³n â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// â”€â”€ LÃ³gica de fichaje â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
const fichar = async () => {
  ...
  try {
    ...
    if (modo.value === 'entrada') {
      // Entrada exitosa â†’ mensaje verde y limpiar
      ...
      // Salida exitosa â†’ guardar datos y pasar a pantalla de reporte
      datosJornada.value = {
        nombre:           data.nombre,
    ...
    const titulos = { 404: 'âŒ Usuario no encontrado', 403: 'ðŸš« Acceso no permitido', 400: 'âš ï¸ Aviso' }
    mostrarError(titulos[error.response?.status] ?? 'âŒ Error', detalle)
  } finally {
    isLoading.value = false
  }
}
// â”€â”€ ConfirmaciÃ³n con cuenta regresiva â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€

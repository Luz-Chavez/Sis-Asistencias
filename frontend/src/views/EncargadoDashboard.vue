        ...
        <div class="flex justify-between h-16 items-center">
          ...
          <div class="flex items-center gap-4">
            <div class="flex items-center gap-3">
              <!-- Logo UMSA -->
              <div class="w-10 h-10 bg-gradient-to-br from-blue-900 to-blue-800 rounded-lg flex items-center justify-center shadow-md">
          ...
          <div class="flex items-center gap-4">
            <div class="hidden sm:flex items-center gap-3 px-3 py-1.5 bg-slate-50 rounded-lg">
              <div class="w-8 h-8 bg-blue-900 rounded-full flex items-center justify-center text-white font-semibold text-xs">
      ...
      <div class="bg-white rounded-2xl shadow-2xl w-full max-w-lg my-8 animate-in fade-in zoom-in duration-200">
        ...
        <div class="bg-gradient-to-r from-blue-900 to-blue-800 px-6 py-5">
          <div class="flex justify-between items-start">
            ...
            <button @click="showModalCrear = false" class="text-blue-200 hover:text-white transition-colors">
              <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"/>
              </svg>
            </button>
